...
co2a  = np.loadtxt('../case0/co2.txt', skiprows=1)
co4a  = np.loadtxt('../case0/co4.txt', skiprows=1)
co8a  = np.loadtxt('../case0/co8.txt', skiprows=1)
cm2a  = np.loadtxt('../case0/cm2.txt', skiprows=1)
cm4a  = np.loadtxt('../case0/cm4.txt', skiprows=1)
cm8a  = np.loadtxt('../case0/cm8.txt', skiprows=1)
ro2a  = np.loadtxt('../case0/ro2.txt', skiprows=1)
ro4a  = np.loadtxt('../case0/ro4.txt', skiprows=1)
ro8a  = np.loadtxt('../case0/ro8.txt', skiprows=1)
rm2a  = np.loadtxt('../case0/rm2.txt', skiprows=1)
rm4a  = np.loadtxt('../case0/rm4.txt', skiprows=1)
rm8a  = np.loadtxt('../case0/rm8.txt', skiprows=1)
to2a  = np.loadtxt('../case0/to2.txt', skiprows=1)
to4a  = np.loadtxt('../case0/to4.txt', skiprows=1)
to8a  = np.loadtxt('../case0/to8.txt', skiprows=1)
tm2a  = np.loadtxt('../case0/tm2.txt', skiprows=1)
tm4a  = np.loadtxt('../case0/tm4.txt', skiprows=1)
tm8a  = np.loadtxt('../case0/tm8.txt', skiprows=1)
